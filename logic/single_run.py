...
def main(run_file, bike_file):
    ...
    if data is not None:
        ...
        displacement_graph_heading = Div(text="<h2 style='font-size:30px; color: white;'>Displacement Graph</h2>")
        regression_graph_heading = Div(text="<h2 style='font-size:30px; color: white;'>Regression Graph</h2>")

        # Create dashboard layout
        dashboard_layout = column(
            displacement_graph_heading,
            displacement_graph,
            regression_graph_heading,
